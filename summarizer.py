...
#     str(MODEL_PATH),
#     model_type="llama",
#     max_new_tokens=120,      # small output window (important)
#     temperature=0.2
# )
...
# Generate concise bullet points that are **relevant to this specific section**. Do not repeat content from other sections and focus on the unique details for this section. Each section should only contain information **directly related to the section's title** and avoid generalizations.
# """
...
# Expand the summary into a detailed paragraph, focusing on adding depth and avoiding repetition across sections. Ensure coherence and clarity.
# """
...
# git clone --single-branch --branch gaurav_jadhav https://github.com/kpawargi/btech-task-resumption-summarizer.git